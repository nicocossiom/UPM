...
// Función que espera hasta que se reciban todos los datos o
// se producza un error
// Extraida del libro "UNIX Network Programming" de Stevens
...
int main(int argc, char *argv[]) {
	...
	while (1) {
		...
		while ((leido=readn(s_conec, buf, TAM))>0)
