...
static int InsertarProceso(struct procesos_st* procesos, struct datos_proceso_st* proc, int tam, int usd) {
    if (tam == 0) {
...
void ProcesarFichero(struct procesos_st* procesos, struct fichero_st* fichero) {
    char action[80];
    int i;
