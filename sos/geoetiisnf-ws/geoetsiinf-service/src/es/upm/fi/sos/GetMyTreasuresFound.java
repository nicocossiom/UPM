...
/**
 * GetMyTreasuresFound bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class GetMyTreasuresFound
    ...
    public static class Factory {
        ...
        public static GetMyTreasuresFound parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetMyTreasuresFound object = new GetMyTreasuresFound();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getMyTreasuresFound".equals(type)) {
                            ...
                            return (GetMyTreasuresFound) es.upm.fi.sos.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
