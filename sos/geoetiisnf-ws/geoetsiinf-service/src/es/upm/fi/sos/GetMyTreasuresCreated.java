...
/**
 * GetMyTreasuresCreated bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class GetMyTreasuresCreated
    ...
    public static class Factory {
        ...
        public static GetMyTreasuresCreated parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetMyTreasuresCreated object = new GetMyTreasuresCreated();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getMyTreasuresCreated".equals(type)) {
                            ...
                            return (GetMyTreasuresCreated) es.upm.fi.sos.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
