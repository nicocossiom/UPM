package academia;
/**
 * Prueba de ColTupla<br>
 * @since 19/03/2019
 * @version 1.0
 * @author JMB
 */
public class ColTuplaTest
{
//  OPERACIONES PARTICULARES  ---------------------------------------
/**
 * POST: resultado es la ICol<Integer> formada por los elementos de
 *       "colArray"
 */
  static public ICol<Integer> consICol (int[] colArray)
  {
    ICol<Integer> resultado =
      new ColTupla<Integer>(colArray.length+10);
...
//  DECLARACIONES DE CONSTANTES DE PRUEBAS  -------------------------
  ...
  static ICol<Integer> col10, col0;
  static Integer prueba1_1, prueba1_2, prueba1_3;
  static Integer prueba2_1, prueba2_2, prueba2_3;
  static Integer prueba3_1, prueba3_2, prueba3_3;

  public static void resetear ()
  {
    col10 = consICol(todos10);
  }
  static void mostrar ()
  {
...
//  DECLARACIONES DE PRUEBAS  ---------------------------------------
  ...
  {
    resetear();
    col10.add(0,11);           // 1�  el 11
    col10.add(5,55);           // 5�  el 55
    col10.add(9,99);           // 9�  el 99
  ...
  {
    resetear();
    col10.set(0,11);           // 1�  el 11
    col10.set(5,55);           // 5�  el 55
    col10.set(9,99);           // 9� el 99
