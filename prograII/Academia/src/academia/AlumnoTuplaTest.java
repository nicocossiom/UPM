...
//  DECLARACIONES DE CONSTANTES DE PRUEBAS  -------------------------
  ...
  public static void resetear ()
  {
    ...
    a2 = new AlumnoTupla("Lola","PÈrez","Cos");
    a3 = new AlumnoTupla("Luis","Pirlo","Casa");
    a4 = new AlumnoTupla("Lola","Prego","CosÌo");
...
//  DECLARACIONES DE PRUEBAS  ---------------------------------------
  ...
  public static boolean prueba4_esIgual ()
  {
    resetear();
    Alumno aa4 = new AlumnoTupla("Lola","Prego","CosÌo");
    Alumno aaa4 = new AlumnoTupla("Lolas","Prego","CosÌo");
    prueba4_1 = a4.esIgual(aa4);
    prueba4_2 = a4.esIgual(aaa4);
...
//  PROGRAMA PRINCIPAL  ---------------------------------------------
  ...
  public static void main(String[] args)
  {
    ...
    System.out.println("prueba4_equals = " + prueba4_esIgual());
