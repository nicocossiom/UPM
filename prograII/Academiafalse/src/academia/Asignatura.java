package academia;
/**
 * Especificación del TAD Asignatura<br>
...
/**
 * POST: Devuelve el número de alumnos matriculados en esta asignatura.
 */
  public int size();
/**
 * PRE: pos IN [0, size()-1]
 * POST: Devuelve el alumno que está en la posición pos.
 */
  public Alumno get (int pos);
/**
 * POST: Devuelve el alumno con el nombre y los apellidos de "al", junto con las notas de al.
 */
...
/**
 * PRE: al tiene que estar en la asignatura
 * POST: Cambia las notas que tenga "al" en la asignatura por
 *       las nuevas que van en el propio parámetro "al".
 */
