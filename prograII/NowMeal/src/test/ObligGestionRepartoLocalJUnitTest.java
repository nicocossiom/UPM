...
public class ObligGestionRepartoLocalJUnitTest {
	 ...
	 */
	@Test
	public void testNotificarEntregaPedido0() throws PedidoSinTransporteAsignado {
		GestionRepartoLocal gestor = new GestionRepartoLocal();
		Cliente cliente = new Cliente("C1");
		Restaurante restaurante = new Restaurante("R1");
		Mapa mapa = new Mapa(20, 20);
	 ...
	 */
	@Test
	public void testNotificarEntregaPedido1() throws PedidoSinTransporteAsignado {
		...
		for (int i = 0; i <NUM_IT; i++){
			...
			IList<String[]> pedMoto = gestor.getCodEsperandoMoto();
			assertEquals("El número de pedidos en espera de moto no coincide", numEsperando, pedMoto.size());			
			IList<String> motosDisp = gestor.getCodMotosDisponibles();
	 ...
	 * Test de notificarEntregaPedido al GestionRepartoLocal
	 * 
	 * <p>Utiliza los constructores de GestionRepartoLocal  
	 * y Pedido, y los métodos asignarPedido</p>
	 * 
	 * <p>Se crea un pedido y se comprueba que se lanza la excepción
	 * si no se le asigna transporte</p>
	 * @throws PedidoSinTransporteAsignado 
	 */
	@Test (expected=PedidoSinTransporteAsignado.class)	
	public void testNotificarEntregaPedido2() throws PedidoSinTransporteAsignado {
		GestionRepartoLocal gestor = new GestionRepartoLocal();
		Cliente cliente = new Cliente("C1");
		Restaurante restaurante = new Restaurante("R1");
		Mapa mapa = new Mapa(20, 20);
		...
		// Instanciar pedido
		pedido = new Pedido(cliente, comidasSolicitadas, restaurante);
		// como el pedido no tiene asignado transporte, debería lanzar
		// la excepción
		gestor.notificarEntregaPedido(pedido);
	}
