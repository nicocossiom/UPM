		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar)
					ok_sofar = new Next(v_3).doCall().checkResult(new java.util.NoSuchElementException());
				if (ok_sofar) {
					v_4 = new Construct_list(TestUtils
							.toGenericArray(new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(3))))
									.doCall();
	...
	public void test_03() {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils.toGenericArray(
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(1), new Integer(1)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2), new Integer(1)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(3)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(12)))).doCall();
					ok_sofar = v_0.checkResult(null);
				}
				if (ok_sofar)
					v_1 = v_0.getValue();
			...
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils.toGenericArray(
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(1), new Integer(1)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2), new Integer(1)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(4)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(7)))).doCall();
					ok_sofar = v_0.checkResult(null);
				}
				if (ok_sofar)
					v_1 = v_0.getValue();
				...
				if (ok_sofar)
					ok_sofar = new Next(v_3).doCall().checkResult(1);
				if (ok_sofar) {
					v_4 = new Construct_list(TestUtils.toGenericArray(
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2), new Integer(3)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(1), new Integer(3)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(6)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(5)))).doCall();
					ok_sofar = v_4.checkResult(null);
				}
				if (ok_sofar)
					v_5 = v_4.getValue();
			...
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils.toGenericArray(
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(1), new Integer(1)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2), new Integer(3)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(5)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(7)))).doCall();
					ok_sofar = v_0.checkResult(null);
				}
				if (ok_sofar)
					v_1 = v_0.getValue();
				...
				if (ok_sofar) {
					v_4 = new Construct_list(TestUtils.toGenericArray(
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(2)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2), new Integer(3)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(7)))).doCall();
					ok_sofar = v_4.checkResult(null);
				}
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils.toGenericArray(
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(1), new Integer(1)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2), new Integer(5)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(5)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(6)))).doCall();
					ok_sofar = v_0.checkResult(null);
				}
				if (ok_sofar)
					v_1 = v_0.getValue();
				...
				if (ok_sofar) {
					v_4 = new Construct_list(TestUtils.toGenericArray(
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(3)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(3)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(1), new Integer(5)))).doCall();
					ok_sofar = v_4.checkResult(null);
				}
				if (ok_sofar)
					v_5 = v_4.getValue();
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils.toGenericArray(
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(1), new Integer(1)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(1)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(3)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2), new Integer(2)))).doCall();
					ok_sofar = v_0.checkResult(null);
				}
				if (ok_sofar)
					v_1 = v_0.getValue();
				...
				if (ok_sofar) {
					v_4 = new Construct_list(TestUtils.toGenericArray(
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(1), new Integer(1)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(1)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(1)))).doCall();
					ok_sofar = v_4.checkResult(null);
				}
				if (ok_sofar)
					v_5 = v_4.getValue();
	...
	public void test_08() {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils.toGenericArray(
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(1), new Integer(2)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(5)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2), new Integer(3)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(6)))).doCall();
					ok_sofar = v_0.checkResult(null);
			...
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils.toGenericArray(
							...
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2), new Integer(1)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(6)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(3)))).doCall();
					ok_sofar = v_0.checkResult(null);
				}
				if (ok_sofar)
					v_1 = v_0.getValue();
				...
				if (ok_sofar) {
					v_4 = new Construct_list(TestUtils.toGenericArray(
							...
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(1), new Integer(3)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2), new Integer(3)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(9)))).doCall();
					ok_sofar = v_4.checkResult(null);
				}
				if (ok_sofar)
					v_5 = v_4.getValue();
			...
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils.toGenericArray(
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(1), new Integer(3)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(3)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2), new Integer(4)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(7)))).doCall();
					ok_sofar = v_0.checkResult(null);
				}
				if (ok_sofar)
	...
	public void test_11() {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils.toGenericArray(
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(1), new Integer(4)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(6)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2), new Integer(2)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(6)))).doCall();
					ok_sofar = v_0.checkResult(null);
				}
				if (ok_sofar)
					v_1 = v_0.getValue();
	...
	public void test_12() {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils
							.toGenericArray(new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2), new Integer(1))))
									.doCall();
					ok_sofar = v_0.checkResult(null);
				}
				if (ok_sofar)
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils.toGenericArray(
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2), new Integer(1)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(1)))).doCall();
					ok_sofar = v_0.checkResult(null);
				}
				if (ok_sofar)
					v_1 = v_0.getValue();
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils.toGenericArray(
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2), new Integer(1)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(2)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(1), new Integer(1)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(2)))).doCall();
					ok_sofar = v_0.checkResult(null);
				}
				if (ok_sofar)
					v_1 = v_0.getValue();
			...
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils.toGenericArray(
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2), new Integer(2)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(1), new Integer(1)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(4)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(3)))).doCall();
					ok_sofar = v_0.checkResult(null);
				}
				if (ok_sofar)
					v_1 = v_0.getValue();
				...
				if (ok_sofar) {
					v_4 = new Construct_list(TestUtils
							.toGenericArray(new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(2))))
									.doCall();
					ok_sofar = v_4.checkResult(null);
				}
				if (ok_sofar)
			...
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils.toGenericArray(
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2), new Integer(3)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(1), new Integer(2)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(10)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(5)))).doCall();
					ok_sofar = v_0.checkResult(null);
				}
				if (ok_sofar)
					v_1 = v_0.getValue();
	...
	public void test_20() {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils
							.toGenericArray(new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(1))))
									.doCall();
					ok_sofar = v_0.checkResult(null);
				}
				if (ok_sofar)
				...
				if (ok_sofar) {
					v_4 = new Construct_list(TestUtils.toGenericArray(
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2), new Integer(1)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(1), new Integer(2)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(1)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(1)))).doCall();
					ok_sofar = v_4.checkResult(null);
				}
				if (ok_sofar)
			...
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils.toGenericArray(
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(1)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(6)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2), new Integer(1)))).doCall();
					ok_sofar = v_0.checkResult(null);
				}
				if (ok_sofar)
					v_1 = v_0.getValue();
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils.toGenericArray(
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(1)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(7)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2), new Integer(5)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(1), new Integer(2)))).doCall();
					ok_sofar = v_0.checkResult(null);
				}
				if (ok_sofar)
					v_1 = v_0.getValue();
			...
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils.toGenericArray(
							...
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(1), new Integer(4)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(5)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2), new Integer(3)))).doCall();
					ok_sofar = v_0.checkResult(null);
				}
				if (ok_sofar)
					v_1 = v_0.getValue();
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils.toGenericArray(
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(3)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(1), new Integer(5)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2), new Integer(4)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(6)))).doCall();
					ok_sofar = v_0.checkResult(null);
				}
			...
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils.toGenericArray(
							...
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(4)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2), new Integer(4)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(1), new Integer(1)))).doCall();
					ok_sofar = v_0.checkResult(null);
				}
				if (ok_sofar)
					v_1 = v_0.getValue();
			...
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils.toGenericArray(
							...
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(1), new Integer(2)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2), new Integer(4)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(4)))).doCall();
					ok_sofar = v_0.checkResult(null);
				}
				if (ok_sofar)
					v_1 = v_0.getValue();
	...
	public void test_33() {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar)
					if (ok_sofar)
						ok_sofar = new IteratorListOk(
								new es.upm.aedlib.positionlist.NodePositionList<es.upm.aedlib.positionlist.NodePositionList<es.upm.aedlib.Pair<Integer, Integer>>>(
										TestUtils.toGenericArray(v_1, v_5)),
								new es.upm.aedlib.positionlist.NodePositionList<es.upm.aedlib.positionlist.NodePositionList<es.upm.aedlib.Pair<Integer, Integer>>>(
										TestUtils.toGenericArray(
												new es.upm.aedlib.positionlist.NodePositionList<es.upm.aedlib.Pair<Integer, Integer>>(
														TestUtils.toGenericArray()),
												new es.upm.aedlib.positionlist.NodePositionList<es.upm.aedlib.Pair<Integer, Integer>>(
														TestUtils.toGenericArray(
																new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3),
																		new Integer(1)),
																new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2),
																		new Integer(1)),
																new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4),
																		new Integer(5)),
																new es.upm.aedlib.Pair<Integer, Integer>(new Integer(1),
				...
				if (ok_sofar)
					if (ok_sofar)
						ok_sofar = new IteratorListOk(
								new es.upm.aedlib.positionlist.NodePositionList<es.upm.aedlib.positionlist.NodePositionList<es.upm.aedlib.Pair<Integer, Integer>>>(
										TestUtils.toGenericArray(v_5, v_1)),
								new es.upm.aedlib.positionlist.NodePositionList<es.upm.aedlib.positionlist.NodePositionList<es.upm.aedlib.Pair<Integer, Integer>>>(
										TestUtils.toGenericArray(
												new es.upm.aedlib.positionlist.NodePositionList<es.upm.aedlib.Pair<Integer, Integer>>(
														TestUtils.toGenericArray(
	...
	public void test_34() {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils
							.toGenericArray(new es.upm.aedlib.Pair<Integer, Integer>(new Integer(1), new Integer(1))))
									.doCall();
					ok_sofar = v_0.checkResult(null);
				}
				if (ok_sofar)
			...
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils.toGenericArray(
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(1), new Integer(1)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(2)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(4)))).doCall();
					ok_sofar = v_0.checkResult(null);
				}
				if (ok_sofar)
					v_1 = v_0.getValue();
			...
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils.toGenericArray(
							...
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(6)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2), new Integer(3)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(8)))).doCall();
					ok_sofar = v_0.checkResult(null);
				}
				if (ok_sofar)
					v_1 = v_0.getValue();
			...
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_4 = new Construct_list(TestUtils.toGenericArray(
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(1), new Integer(2)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(5)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(11)))).doCall();
					ok_sofar = v_4.checkResult(null);
				}
				if (ok_sofar)
					v_5 = v_4.getValue();
			...
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils.toGenericArray(
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(1), new Integer(2)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(5)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2), new Integer(6)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(6)))).doCall();
					ok_sofar = v_0.checkResult(null);
				}
				if (ok_sofar)
			...
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils.toGenericArray(
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2), new Integer(1)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(6)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(8)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(1), new Integer(2)))).doCall();
					ok_sofar = v_0.checkResult(null);
				}
				if (ok_sofar)
			...
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_4 = new Construct_list(TestUtils.toGenericArray(
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(3)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(1), new Integer(3)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(9)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2), new Integer(4)))).doCall();
					ok_sofar = v_4.checkResult(null);
				}
				if (ok_sofar)
					v_5 = v_4.getValue();
			...
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils.toGenericArray(
							...
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(1)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(1), new Integer(1)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(2)))).doCall();
					ok_sofar = v_0.checkResult(null);
				}
				if (ok_sofar)
					v_1 = v_0.getValue();
			...
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils.toGenericArray(
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2), new Integer(4)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(6)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(10)))).doCall();
					ok_sofar = v_0.checkResult(null);
				}
				if (ok_sofar)
					v_1 = v_0.getValue();
	...
	public void test_62() {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils
							.toGenericArray(new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(2))))
									.doCall();
					ok_sofar = v_0.checkResult(null);
				}
				if (ok_sofar)
	...
	public void test_66() {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils.toGenericArray(
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(8)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(2), new Integer(4)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(5)))).doCall();
					ok_sofar = v_0.checkResult(null);
				}
	...
	public void test_67() {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils
							.toGenericArray(new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(1))))
									.doCall();
					ok_sofar = v_0.checkResult(null);
				}
				if (ok_sofar)
	...
	public void test_70() {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					v_0 = new Construct_list(TestUtils.toGenericArray(
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(4), new Integer(12)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(3), new Integer(7)),
							new es.upm.aedlib.Pair<Integer, Integer>(new Integer(1), new Integer(1)))).doCall();
					ok_sofar = v_0.checkResult(null);
				}
				if (ok_sofar)
	...
	static class MultiSetIteratorUtils {
		...
		public static boolean iteratorListOk1(NodePositionList<Pair<Integer, Integer>> l,
			...
			if (!TestUtils.sameElements(expected, l)) {
				TestUtils.printError(TestUtils.ExecutionTime.AFTER, "the list that the iterator is iterating over -- "
						+ l + " -- is incorrect.\n" + "It should contain the items " + expected);
				return false;
			}
			return true;
		}
