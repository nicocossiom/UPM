...
public class TesterInd5 {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					ok_sofar = new FindTree(new String("HashTable.java"), tree).doCall()
							.checkResult(new String[] { new String("/pelis/pelis/HashTable.java") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					ok_sofar = new FindTree(new String("PlanificacionFiesta.doc"), tree).doCall()
							.checkResult(new String[] { new String("/various/tmp/PlanificacionFiesta.doc") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = stack.pop();
					cursor = tree.addChildLast(cursor, new String(new String("peli.mkv")));
					ok_sofar = new FindTree(new String("peli.mkv"), tree).doCall()
							.checkResult(new String[] { new String("/java/various/peli.mkv") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = stack.pop();
					cursor = tree.addChildLast(cursor, new String(new String("peli.mkv")));
					ok_sofar = new FindTree(new String("peli.mkv"), tree).doCall().checkResult(
							new String[] { new String("/pelis/tmp/peli.mkv"), new String("/pelis/privado/peli.mkv") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = stack.pop();
					cursor = tree.addChildLast(cursor, new String(new String("TicketsMundialCatar2022.txt")));
					ok_sofar = new FindTree(new String("281929.JPEG"), tree).doCall()
							.checkResult(new String[] { new String("/musica/various/privado/281929.JPEG") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = tree.addChildLast(cursor, new String(new String("281929.JPEG")));
					ok_sofar = new FindTree(new String("281929.JPEG"), tree).doCall()
							.checkResult(new String[] { new String("/privado/trash/src/281929.JPEG") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = tree.addChildLast(cursor, new String(new String("Tester.java")));
					ok_sofar = new FindTree(new String("281929.JPEG"), tree).doCall()
							.checkResult(new String[] { new String("/trash/junk/tmp/281929.JPEG") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = tree.addChildLast(cursor, new String(new String("examen-AED.pdf")));
					ok_sofar = new FindTree(new String("PlanificacionFiesta.doc"), tree).doCall()
							.checkResult(new String[] { new String("/various/viajes/classes/PlanificacionFiesta.doc"),
									new String("/various/pelis/viajes/PlanificacionFiesta.doc") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = stack.pop();
					cursor = tree.addChildLast(cursor, new String(new String("HashTable.java")));
					ok_sofar = new FindTree(new String("TicketsMundialCatar2022.txt"), tree).doCall()
							.checkResult(new String[] { new String("/src/musica/classes/TicketsMundialCatar2022.txt"),
									new String("/src/musica/src/TicketsMundialCatar2022.txt") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = tree.addChildLast(cursor, new String(new String("peli.mkv")));
					ok_sofar = new FindTree(new String("TicketsMundialCatar2022.txt"), tree).doCall()
							.checkResult(new String[] { new String("/viajes/privado/pelis/TicketsMundialCatar2022.txt"),
									new String("/viajes/pelis/java/TicketsMundialCatar2022.txt"),
									new String("/viajes/various/musica/TicketsMundialCatar2022.txt") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = stack.pop();
					cursor = tree.addChildLast(cursor, new String(new String("examen-AED.pdf")));
					ok_sofar = new FindTree(new String("examen-AED.pdf"), tree).doCall()
							.checkResult(new String[] { new String("/privado/classes/privado/examen-AED.pdf") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = tree.addChildLast(cursor, new String(new String("peli.mkv")));
					ok_sofar = new FindTree(new String("peli.mkv"), tree).doCall()
							.checkResult(new String[] { new String("/java/tmp/privado/peli.mkv"),
									new String("/java/musica/trash/peli.mkv"),
									new String("/java/musica/various/peli.mkv") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = tree.addChildLast(cursor, new String(new String("PlanificacionFiesta.doc")));
					ok_sofar = new FindTree(new String("peli.mkv"), tree).doCall()
							.checkResult(new String[] { new String("/pelis/trash/various/peli.mkv") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = tree.addChildLast(cursor, new String(new String("peli.mkv")));
					ok_sofar = new FindTree(new String("HashTable.java"), tree).doCall()
							.checkResult(new String[] { new String("/java/various/pelis/tmp/HashTable.java"),
									new String("/java/various/pelis/pelis/HashTable.java") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = stack.pop();
					cursor = tree.addChildLast(cursor, new String(new String("Tester.java")));
					ok_sofar = new FindTree(new String("PlanificacionFiesta.doc"), tree).doCall().checkResult(
							new String[] { new String("/pelis/trash/java/viajes/PlanificacionFiesta.doc") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = stack.pop();
					cursor = tree.addChildLast(cursor, new String(new String("peli.mkv")));
					ok_sofar = new FindTree(new String("TicketsMundialCatar2022.txt"), tree).doCall().checkResult(
							new String[] { new String("/trash/pelis/junk/various/TicketsMundialCatar2022.txt") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = tree.addChildLast(cursor, new String(new String("281929.JPEG")));
					ok_sofar = new FindTree(new String("examen-AED.pdf"), tree).doCall()
							.checkResult(new String[] { new String("/classes/classes/tmp/pelis/examen-AED.pdf") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = tree.addChildLast(cursor, new String(new String("peli.mkv")));
					ok_sofar = new FindTree(new String("peli.mkv"), tree).doCall()
							.checkResult(new String[] { new String("/junk/tmp/src/java/peli.mkv"),
									new String("/junk/tmp/src/privado/peli.mkv"),
									new String("/junk/privado/junk/privado/peli.mkv"),
									new String("/junk/privado/junk/tmp/peli.mkv"),
									new String("/junk/privado/musica/pelis/peli.mkv"),
									new String("/junk/java/junk/various/peli.mkv") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = tree.addChildLast(cursor, new String(new String("viva_las_vegas.mp3")));
					ok_sofar = new FindTree(new String("peli.mkv"), tree).doCall()
							.checkResult(new String[] { new String("/musica/java/pelis/classes/peli.mkv") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = tree.addChildLast(cursor, new String(new String("examen-AED.pdf")));
					ok_sofar = new FindTree(new String("281929.JPEG"), tree).doCall()
							.checkResult(new String[] { new String("/junk/pelis/viajes/viajes/privado/281929.JPEG") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = stack.pop();
					cursor = tree.addChildLast(cursor, new String(new String("281929.JPEG")));
					ok_sofar = new FindTree(new String("281929.JPEG"), tree).doCall().checkResult(
							new String[] { new String("/musica/viajes/privado/various/musica/281929.JPEG") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = tree.addChildLast(cursor, new String(new String("TicketsMundialCatar2022.txt")));
					ok_sofar = new FindTree(new String("281929.JPEG"), tree).doCall()
							.checkResult(new String[] { new String("/privado/junk/src/pelis/trash/281929.JPEG"),
									new String("/privado/junk/src/pelis/tmp/281929.JPEG") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = tree.addChildLast(cursor, new String(new String("viva_las_vegas.mp3")));
					ok_sofar = new FindTree(new String("281929.JPEG"), tree).doCall()
							.checkResult(new String[] { new String("/viajes/junk/pelis/java/musica/281929.JPEG"),
									new String("/viajes/junk/trash/tmp/musica/281929.JPEG") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = tree.addChildLast(cursor, new String(new String("peli.mkv")));
					ok_sofar = new FindTree(new String("HashTable.java"), tree).doCall()
							.checkResult(new String[] { new String("/java/java/viajes/java/trash/HashTable.java"),
									new String("/java/tmp/various/viajes/various/HashTable.java") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = stack.pop();
					cursor = tree.addChildLast(cursor, new String(new String("Tester.java")));
					ok_sofar = new FindTree(new String("HashTable.java"), tree).doCall().checkResult(
							new String[] { new String("/musica/viajes/classes/viajes/various/HashTable.java") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = tree.addChildLast(cursor, new String(new String("PlanificacionFiesta.doc")));
					ok_sofar = new FindTree(new String("HashTable.java"), tree).doCall().checkResult(
							new String[] { new String("/pelis/pelis/trash/various/various/HashTable.java") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = tree.addChildLast(cursor, new String(new String("examen-AED.pdf")));
					ok_sofar = new FindTree(new String("HashTable.java"), tree).doCall().checkResult(
							new String[] { new String("/privado/various/musica/classes/junk/HashTable.java") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = tree.addChildLast(cursor, new String(new String("viva_las_vegas.mp3")));
					ok_sofar = new FindTree(new String("PlanificacionFiesta.doc"), tree).doCall().checkResult(
							new String[] { new String("/pelis/trash/various/classes/junk/PlanificacionFiesta.doc") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = stack.pop();
					cursor = tree.addChildLast(cursor, new String(new String("Tester.java")));
					ok_sofar = new FindTree(new String("Tester.java"), tree).doCall().checkResult(
							new String[] { new String("/musica/musica/privado/java/various/Tester.java") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = stack.pop();
					cursor = tree.addChildLast(cursor, new String(new String("PlanificacionFiesta.doc")));
					ok_sofar = new FindTree(new String("Tester.java"), tree).doCall()
							.checkResult(new String[] { new String("/src/java/trash/src/privado/Tester.java") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = tree.addChildLast(cursor, new String(new String("peli.mkv")));
					ok_sofar = new FindTree(new String("Tester.java"), tree).doCall()
							.checkResult(new String[] { new String("/tmp/trash/src/src/trash/Tester.java") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = tree.addChildLast(cursor, new String(new String("HashTable.java")));
					ok_sofar = new FindTree(new String("Tester.java"), tree).doCall()
							.checkResult(new String[] { new String("/trash/java/classes/privado/java/Tester.java") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = tree.addChildLast(cursor, new String(new String("281929.JPEG")));
					ok_sofar = new FindTree(new String("Tester.java"), tree).doCall()
							.checkResult(new String[] { new String("/trash/pelis/java/various/various/Tester.java"),
									new String("/trash/pelis/java/various/privado/Tester.java"),
									new String("/trash/pelis/java/various/junk/Tester.java"),
									new String("/trash/pelis/java/src/src/Tester.java") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = tree.addChildLast(cursor, new String(new String("peli.mkv")));
					ok_sofar = new FindTree(new String("Tester.java"), tree).doCall()
							.checkResult(new String[] { new String("/viajes/src/classes/tmp/various/Tester.java"),
									new String("/viajes/src/classes/tmp/classes/Tester.java") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					ok_sofar = new FindTree(new String("TicketsMundialCatar2022.txt"), tree).doCall()
							.checkResult(new String[] {
									new String("/junk/privado/pelis/trash/various/TicketsMundialCatar2022.txt"),
									new String("/junk/viajes/java/src/pelis/TicketsMundialCatar2022.txt"),
									new String("/junk/viajes/musica/classes/trash/TicketsMundialCatar2022.txt") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					ok_sofar = new FindTree(new String("TicketsMundialCatar2022.txt"), tree).doCall()
							.checkResult(new String[] {
									new String("/trash/junk/classes/trash/junk/TicketsMundialCatar2022.txt"),
									new String("/trash/junk/classes/trash/trash/TicketsMundialCatar2022.txt"),
									new String("/trash/junk/privado/privado/various/TicketsMundialCatar2022.txt") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = tree.addChildLast(cursor, new String(new String("PlanificacionFiesta.doc")));
					ok_sofar = new FindTree(new String("examen-AED.pdf"), tree).doCall()
							.checkResult(new String[] { new String("/classes/src/tmp/classes/tmp/examen-AED.pdf"),
									new String("/classes/musica/various/pelis/musica/examen-AED.pdf") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = tree.addChildLast(cursor, new String(new String("HashTable.java")));
					ok_sofar = new FindTree(new String("examen-AED.pdf"), tree).doCall()
							.checkResult(new String[] { new String("/musica/src/viajes/tmp/pelis/examen-AED.pdf") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = tree.addChildLast(cursor, new String(new String("examen-AED.pdf")));
					ok_sofar = new FindTree(new String("examen-AED.pdf"), tree).doCall()
							.checkResult(new String[] { new String("/pelis/pelis/src/privado/junk/examen-AED.pdf"),
									new String("/pelis/pelis/src/privado/java/examen-AED.pdf") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = tree.addChildLast(cursor, new String(new String("PlanificacionFiesta.doc")));
					ok_sofar = new FindTree(new String("examen-AED.pdf"), tree).doCall()
							.checkResult(new String[] { new String("/trash/tmp/viajes/trash/privado/examen-AED.pdf"),
									new String("/trash/tmp/musica/tmp/tmp/examen-AED.pdf") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = tree.addChildLast(cursor, new String(new String("PlanificacionFiesta.doc")));
					ok_sofar = new FindTree(new String("peli.mkv"), tree).doCall()
							.checkResult(new String[] { new String("/tmp/classes/trash/privado/java/peli.mkv"),
									new String("/tmp/classes/trash/privado/classes/peli.mkv"),
									new String("/tmp/classes/java/viajes/junk/peli.mkv") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
		...
		try {
			resultIs = Assertions.assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
				...
				if (ok_sofar) {
					...
					cursor = stack.pop();
					cursor = tree.addChildLast(cursor, new String(new String("PlanificacionFiesta.doc")));
					ok_sofar = new FindTree(new String("viva_las_vegas.mp3"), tree).doCall().checkResult(
							new String[] { new String("/src/privado/various/musica/pelis/viva_las_vegas.mp3"),
									new String("/src/privado/src/pelis/src/viva_las_vegas.mp3") });
				}
				return ok_sofar;
			});
		} catch (org.opentest4j.AssertionFailedError exc) {
	...
	static class FindChecker {
		...
		static boolean checkFind(FindTree call, TestResult<Void, String[]> result, String[] expected) {
			if (!call.noException())
				return false;
			else {
		...
		static boolean check_find(String fileName, Tree<String> tree, String[] expected) {
			...
			if (!ts1.equals(ts2)) {
				TestUtils.printError(TestUtils.ExecutionTime.LAST,
						"\nthe call " + callString + "printed a set of paths:\n" + Arrays.toString(printedLines)
